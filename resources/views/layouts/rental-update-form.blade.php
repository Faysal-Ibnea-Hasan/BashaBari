        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form autocomplete="off" action="{{Route('rental.form.update.put',['id'=>$data->id])}}" method="POST">
                @csrf
                @method('PUT')
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="flat_Id" id="flat_Id">
                      ...
                      <option name="flat_Id" value="{{ $data->Buildings->name }}" >{{ $data->Buildings->name }}</option>
