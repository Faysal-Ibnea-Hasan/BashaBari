        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form autocomplete="off" action="{{Route('flat.form.post')}}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="floor" class="form-control"  placeholder="Enter Floor Number">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Area</label>
                    <input type="text" name="area" class="form-control"  placeholder="Area Details">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="rent_value" class="form-control" placeholder="Enter Rent Amount">
                  </div>
                  <div class="form-group">
